# Angular NestJS GraphQL Example
...
Libraries are shareable across libraries and applications. They can be imported from `@interview-prep/mylib`.
...
- npm i graphql-subscriptions [GraphQL Subscriptions (for the PubSub stuff)](https://docs.nestjs.com/graphql/subscriptions)
